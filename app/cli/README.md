...
The output needs extrusion and geometry checks before printing. Area-based cleanup is not a minimum line-width or physical printability check. svgify is MPL-2.0; the sharp dependency is Apache-2.0 and includes its own third-party notices.
